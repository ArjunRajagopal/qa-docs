...
# -----------------------------------------------------------------------------------------------------#
	...
	def test_03_guestuser_donation_ORG()
		...
		searchOrg("Minnesota Community Foundation")
		donateUsingNewCard("10.00", "Sample UserIE1", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "normalStage1@razooIE20.com")
		createRazooAccount("Normal1", "UserIE", "normalStage1@razooIE20.com", "123456")
...
# --------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_normaluser_share_donation_FR_NewCard()
		...
		searchOrg("Minnesota Community Foundation")
		createStoryPage("Minnesota Community Foundation", "RazooStageIEFR20 for Minnesota Community Foundation", "Summary Part ", "Story Part", 
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_05_orgadmin_donation_PRO_SavedCard()
		...
		grantOrgAdminRights("/admin", "normalStage1@razooIE20.com", "410832480")
		logout()
		# PRE - CONDITION - END
		login("normalStage1@razooIE20.com", "123456")
		createStoryPage("Minnesota Community Foundation", "RazooStageIEPRO20 of Minnesota Community Foundation", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=30", "link=Donations", "10", "Suggested Amount")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_08_change_mypassword()
		...
		logout()
		login("normalStage1@razooIE20.com", "1234567")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_01_createORG_NPOdetails_audit()
		...
		login("srajkumar.here@gmail.com", "razoo1")
		createOrg("/admin", "911111121", "RazooStageIE ORG20", "IE City", "IE State")
		editNpoDetails("First Name", "Last Name", "Addres 1", "Addres 2", "razooStage@IE.com", "123456789")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_09_createaccount_while_donating()
		...
		sleep 5
		searchOrg("RazooStageIE ORG20")
		gotoDonFormClickSignup("10.00")
		createRazooAccount("Normal2", "UserIE", "normalStage2@razooIE20.com", "123456")
		donateUsingNewCard("10.00", "Normal2 UserIE", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normalStage2@razooIE20.com")
		normalUserSharePage("sharepage@aol.com", "/story/Minnesota-Community-Foundation")
		checkMydonation("10.00")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_10_login_while_donating()
		...
		searchOrg("RazooStageIE ORG20")
		gotoDonFormClickLogin("11.00", "normalStage2@razooIE20.com", "123456")
		donateUsingNewCard("11.00", "Normal2 UserIE", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normalStage2@razooIE20.com")
		normalUserSharePage("sharepage@aol.com", "/story/Minnesota-Community-Foundation")
