...
# 14-July-2011 - Update - Release 1.20. # 23-July-2011 - Update - Release 1.22. 
#-----------------------------------------------------------------------------#
...
def createStoryPage(ein_number, org_name, story_name, story_summary, page_story, youtube_url, desig_value, goal_amount,  goal_date, admin_links, sug_amount, sug_desc)
	...
	begin
		assert $browser.is_text_present("Your fundraiser is 74% complete.")
		puts "Step 11 : Passed. 74% complete label gets displayed in FR completion steps progress bar."
	rescue Test::Unit::AssertionFailedError
