...
# --------------------------------------------------------------------------------------------------------------------#
	...
	def test_01_guestuser_share_story()
		...
		donateUsingNewCard("10.00", "Sample UserSafari", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "sampleuserSafari@aol.com")
...
# -----------------------------------------------------------------------------------------------------#
	...
	def test_02_guestuser_donation_ORG()
		...
		searchOrg("Harvard College")
		donateUsingNewCard("10.00", "Sample UserSafari", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "normaltrunk1@razooSafari1.com")
		createRazooAccount("Normal1", "UserSafari", "normaltrunk1@razooSafari1.com", "123456")
...
# --------------------------------------------------------------------------------------------------------------------------------------#
	def test_03_normaluser_share_donation_FR_NewCard()
		...
		searchOrg("Harvard College")
		createStoryPage("Harvard College", "RazooTrunkSafariFR1 for Harvard College", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=31", "link=Donations", "10", "Suggested Amount")
		donateUsingNewCard("10.50", "Normal1 UserSafari", "2nd Street", "Washington DC", 
				"Washington", "95008", "4111111111111111", "123", "normaltrunk1@razooSafari1.com")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_orgadmin_donation_PRO_SavedCard()
		...
		grantOrgAdminRights("/admin", "normaltrunk1@razooSafari1.com", "042103580")
		logout()
		# PRE - CONDITION - END
		login("normaltrunk1@razooSafari1.com", "123456")
		createStoryPage("Harvard College", "RazooTrunkSafariPRO1 of Harvard College", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=31", "link=Donations", "10", "Suggested Amount")
...
#~ # ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_05_AddNewCard_deletecomment_removefan()
		...
		removeFan("RazooTrunkSafariFR1 for Harvard College")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_07_change_mypassword()
		...
		logout()
		login("normaltrunk1@razooSafari1.com", "1234567")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_08_createORG_NPOdetails_audit()
		...
		login("ebi@srasys.co.in", "123456")
		createOrg("/admin", "311111115", "RazooTrunkSafari ORG1", "Safari City", "Safari State")
		editNpoDetails("First Name", "Last Name", "Addres 1", "Addres 2", "razootrunk@Safari.com", "123456789")
		auditVerifyOrg("VerifSafarid this ORG")
		verifyNpoDetails()
		becomeFan()
		logout()
		sleep 250
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_09_createaccount_while_donating()
		...
		searchOrg("RazooTrunkSafari ORG1")
		gotoDonFormClickSignup("10.00")
		createRazooAccount("Normal2", "UserSafari", "normaltrunk2@razooSafari1.com", "123456")
		donateUsingNewCard("10.00", "Normal2 UserSafari", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normaltrunk2@razooSafari1.com")
		normalUserSharePage("sharepage@aol.com")
		checkMydonation("10.00")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_10_login_while_donating()
		...
		searchOrg("RazooTrunkSafari ORG1")
		gotoDonFormClickLogin("10.00", "normaltrunk2@razooSafari1.com", "123456")
		donateUsingNewCard("10.00", "Normal2 UserSafari", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normaltrunk2@razooSafari1.com")
		normalUserSharePage("sharepage@aol.com")
		logout()
