...
# -----------------------------------------------------------------------------------------------------#
	...
	def test_03_guestuser_donation_ORG()
		...
		donateUsingNewCard("10.00", "Sample UserFF1", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "normaltrunk1@razoofirefox1.com")
		createRazooAccount("Normal1", "UserFF", "normaltrunk1@razoofirefox1.com", "123456")
...
# --------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_normaluser_share_donation_FR_NewCard()
		...
		searchOrg("Harvard College")
		createStoryPage("Harvard College", "RazooTrunkFirefoxFR1 for Harvard College", "Summary Part ", "Story Part", 
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_05_orgadmin_donation_PRO_SavedCard()
		...
		grantOrgAdminRights("/admin", "normaltrunk1@razoofirefox1.com", "042103580")
		logout()
		# PRE - CONDITION - END
		login("normaltrunk1@razoofirefox1.com", "123456")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_08_change_mypassword()
		...
		logout()
		login("normaltrunk1@razoofirefox1.com", "1234567")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_08_createORG_NPOdetails_audit()
		...
		login("ebi@srasys.co.in", "123456")
		createOrg("/admin", "911111111", "RazooTrunkFirefox ORG1", "Firefox City", "Firefox State")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_09_createaccount_while_donating()
		...
		sleep 5
		searchOrg("RazooTrunkFirefox ORG1")
		gotoDonFormClickSignup("10.00")
		createRazooAccount("Normal2", "UserFF", "normaltrunk2@razoofirefox1.com", "123456")
		donateUsingNewCard("10.00", "Normal2 UserFF", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normaltrunk2@razoofirefox1.com")
		normalUserSharePage("sharepage@aol.com")
		checkMydonation("10.00")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_10_login_while_donating()
		...
		searchOrg("RazooTrunkFirefox ORG1")
		gotoDonFormClickLogin("10.00", "normaltrunk2@razoofirefox1.com", "123456")
		donateUsingNewCard("10.00", "Normal2 UserFF", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normaltrunk2@razoofirefox1.com")
		normalUserSharePage("sharepage@aol.com")
		logout()
