...
# ---------------- PRE - CONDITION FOR SANITY ------------
	...
	def test_01_precondition_for_sanity()
		...
		createRazooAccount("Norma1.9_1", "User", "norma1.9_1user@aol.com", "123456")
		logout()	
		createRazooAccount("OrgAdmin1.9_1", "User", "orgadmin1.9_1@aol.com", "123456")
		logout()
		login("ebi@srasys.co.in", "123456")
		grantOrgAdminRights("/admin", "orgadmin1.9_1@aol.com", "042103580")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_02_normaluser_clickall_links()
		...
		login("norma1.9_luser@aol.com", "123456")
		verifyHeaderLinks()
		verifyFooterLinks()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_03_storyadmin_clickall_links()
		...
		login("orgadmin1.9_1@aol.com", "123456")
		verifyHeaderLinks()
		verifyFooterLinks()
		verifyMyAccountLinks()
