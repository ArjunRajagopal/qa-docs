...
$personuser = 7; $causeuser = 8
$globalAdmin = 9; $other_amounts = 5; 
$visaCard = 13; $amexCard = 14; $masterCard = 15; $discoverCard = 16;
$createOrg = 20; $storyNames = 24; $createStory = 28;
$createTeamForSingleCause = 32; $createTeamForMultipleCause = 32; $donateAnywere = 36;
$matchingGrant = 40; $offlineDonations = 44; $myMeetup = 48
$givingCard = 52; $school = 56


# -------------------------------------- START : GETTING TEST DATA'S FROM EXCEL ------------------------
$test_data ="K:\\EBI\\Razoo\\Automation\\Selenium\\Release 2.19\\Razoo\\Razoo - FF\\Razoo_Firefox_TestData.xls"
...
# -------------------------------------------------------------------------------------------------------------------------#
# SCENARIO 21 : AS A STORYADMIN, ISBAT INSTALL MY WIDGET ON FACEBOOK PAGE.																			
# -------------------------------------------------------------------------------------------------------------------------#
...
# ----------------------------------------------------------------------------------------------------------------------#
# SCENARIO 22: AS A STORY ADMIN,  ISBAT PURCHASE A GIVING CARD OF 10 DOLLAR WORTH.																		
# ----------------------------------------------------------------------------------------------------------------------#
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
# SCENARIO 23 : AS A STORY ADMIN, ISBAT CREATE A THEMED FUNDRAISER FROM A TEMPLATE.																			
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
# SCENARIO 24 : AS A RAZOO GLOBAL ADMIN, ISBAT REMOVE ORG ADMINS FROM THE ORG PAGE.
#
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
# SCENARIO 25 : AS A NORMAL USER, ISBAT VERIFY PERSON AND ORG UNDER 'PERSON I MAY KNOW' & 'CAUSES I MAY LIKE'
...
# -------------------------------------------------------------------------------------------------#
# SCENARIO 26 : AS A STORY ADMIN, DELETE MY STORY PAGE FROM RAZOO.
#
# -------------------------------------------------------------------------------------------------#
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
# SCENARIO 27 : AS A RAZOO GLOBAL ADMIN, ISBAT CREATE 'CAN IMPERSONATE' PERMISSION.
#
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
# SCENARIO 28 : AS RAZOO ADMIN ISBAT ADD & VERIFY STORY URN IN 'CAUSES BY AMOUNT' SECTION#
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
	def scenario28()
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
# SCENARIO 29 : AS RAZOO ADMIN ISBAT CREATE SCHOOL AND MAKE A DONATION
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#	
	def scenario29()
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
# SCENARIO 30 : AS A GUEST USER, ISBAT CREATE A RAZOO ACCOUNT BY CLICKING THE 'SIGN UP' LINK AT THE TOP HEADER
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
	...
	def scenario30()
		...
		logout()
		puts "---------------------- END OF SCENARIO 30 ----------------------"
		puts"Duration: #{Time.now - $start} seconds"
	
	end
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
# SCENARIO 31 : AS AN USER ISBAT LINK MY GMAIL/FACEBOOK ACCOUNT WITH THE RAZOO APPLICATION.
#
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
...
#This method helps to stop the Current browser
	...
	def test_01_Razoo()
		...
		scenario22() #As Story admin ISBAT purchase Giving Card.	
		
		#scenario23() #Themed Fundraiser functionality - Removed from Release 2.1.	
		
		scenario24() #As Global Admin ISBAT remove ORG admin rights.
		
		scenario25() # Verify 'Person I may Know' & 'Causes I may like' section.										
		
		scenario26() # As Story admin Delete PRO/FR page.
		
		scenario27() #As RazAdmin ISBAT impersonate.
		
		#scenario28()  #As RazAdmin ISBAT add/Verify Story in 'Causes By Amount Section'.  - Removed from Release 2.18
		
		scenario29() #As Raz Admin Create School and Donate
		
		scenario30() #As a Guest User, ISBAT create a Razoo Account by clicking the 'Sign up' link modal dialog at the Top nav and Follow the User.
		
		scenario21() #As Story admin ISBAT install widget on my facebook page.	
		
		scenario31() # As a User ISBAT login via Facebook/Gmail options.
		
		scenario32() #Stop browser
