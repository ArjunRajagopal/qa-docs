...
# -----------------------------------------------------------------------------------------------------#
	...
	def test_01_guestuser_donation_ORG()
		...
		viewComments()
		createRazooAccount("Sample", "UserIE", "normal@iExplorer5.com", "123456")
...
# ----------------------------------------------------------------------------------------------------------------------------------#
	def test_02_normaluser_donation_FR_NewCard()
		...
		searchOrg("Minnesota Community Foundation")
		createStoryPage("Minnesota Community Foundation", "iExplorer FR5 for Minnesota Community Foundation", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=31", "link=Donations", "10", "Suggested Amount")
		donateUsingNewCard("10.50", "Mr SampleIE", "2nd Street", "Washington DC", 
				"Washington", "95008", "4111111111111111", "123", "normal@iExplorer5.com")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_03_orgadmin_donation_PRO_SavedCard()
		...
		grantOrgAdminRights("/admin", "normal@iExplorer5.com", "410832480")
		logout()
		# PRE - CONDITION - END
		login("normal@iExplorer5.com", "123456")
		createStoryPage("Minnesota Community Foundation", "iExplorer PRO5 of Minnesota Community Foundation", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=31", "link=Donations", "10", "Suggested Amount")
...
#~ # ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_AddNewCard_deletecomment_removefan()
		...
		removeFan("iExplorer FR5 for Minnesota Community Foundation")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_06_change_mypassword()
		...
		logout()
		login("normal@iExplorer5.com", "1234567")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_07_createORG_NPOdetails_audit()
		...
		login("srajkumar.here@gmail.com", "razoo1")
		createOrg("/admin", "211111115", "iExplorer ORG5", "iExplorer City", "iExplorer State")
