...
# -----------------------------------------------------------------------------------------------------#
	...
	def test_01_guestuser_donation_ORG()
		...
		donateUsingNewCard("10.00", "Sample UserFF1", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "sampleuserff1@aol.com")
		viewComments()
		createRazooAccount("Sample", "UserFF1", "normal1@razoofirefox2.com", "123456")
...
# ----------------------------------------------------------------------------------------------------------------------------------#
	def test_02_normaluser_donation_FR_NewCard()
		...
		searchOrg("Minnesota Community Foundation")
		createStoryPage("Minnesota Community Foundation", "RazooFirefoxFRX for Minnesota Community Foundation", "Summary Part ", "Story Part", 
		...
		donateUsingNewCard("10.50", "Sample UserFF1", "2nd Street", "Washington DC", 
				"Washington", "95008", "4111111111111111", "123", "normal1@razoofirefox2.com")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_03_orgadmin_donation_PRO_SavedCard()
		...
		grantOrgAdminRights("/admin", "normal1@razoofirefox2.com", "410832480")
		logout()
		# PRE - CONDITION - END
		login("normal1@razoofirefox2.com", "123456")
		createStoryPage("Minnesota Community Foundation", "RazooFirefoxPROX of Minnesota Community Foundation", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=31", "link=Donations", "10", "Suggested Amount")
...
#~ # ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_AddNewCard_deletecomment_removefan()
		...
		removeFan("RazooFirefoxFRX for Minnesota Community Foundation")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_06_change_mypassword()
		...
		logout()
		login("normal1@razoofirefox2.com", "1234567")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_07_createORG_NPOdetails_audit()
		...
		login("srajkumar.here@gmail.com", "razoo1")
		createOrg("/admin", "411111112", "RazooFirefox ORGX", "Firefox City", "Firefox State")
