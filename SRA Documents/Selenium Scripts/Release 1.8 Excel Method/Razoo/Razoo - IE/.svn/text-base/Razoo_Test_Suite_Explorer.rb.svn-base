...
$test_data ="D:\\EBI\\MyProjects\\Razoo\\Automation\\Selenium\\Selenium2\\ModularFramework\\Release 1.8 Excel Method\\RazooTestData.xls"
	...
	$tip_amount = workSheet.Cells($other_amounts, "J").value
...
# --------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_normaluser_share_donation_FR_NewCard()
		...
		donateUsingNewCard($amount_cent, $normal1_nameoncard, $street, $state, 
					$city, $pin_code, $visacard_number, $visa_seccode, $normal1don_emailId)
		normalUserSharePage($share_emailId, $share_storyurl)
