...
# -----------------------------------------------------------------------------------------------------#
	...
	def test_03_guestuser_donation_ORG()
		...
		donateUsingNewCard("10.00", "Sample UserIE1", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "normaltrunk1@razooIE20.com")
		createRazooAccount("Normal1", "UserIE", "normaltrunk1@razooIE20.com", "123456")
...
# --------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_normaluser_share_donation_FR_NewCard()
		...
		searchOrg("Harvard College")
		createStoryPage("Harvard College", "RazooTrunkIEFR20 for Harvard College", "Summary Part ", "Story Part", 
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_05_orgadmin_donation_PRO_SavedCard()
		...
		grantOrgAdminRights("/admin", "normaltrunk1@razooIE20.com", "042103580")
		logout()
		# PRE - CONDITION - END
		login("normaltrunk1@razooIE20.com", "123456")
		createStoryPage("Harvard College", "RazooTrunkIEPRO20 of Harvard College", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=30", "link=Donations", "10", "Suggested Amount")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_08_change_mypassword()
		...
		logout()
		login("normaltrunk1@razooIE20.com", "1234567")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_01_createORG_NPOdetails_audit()
		...
		login("ebi@srasys.co.in", "123456")
		createOrg("/admin", "911111121", "RazooTrunkIE ORG20", "IE City", "IE State")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_09_createaccount_while_donating()
		...
		sleep 5
		searchOrg("RazooTrunkIE ORG20")
		gotoDonFormClickSignup("10.00")
		createRazooAccount("Normal2", "UserIE", "normaltrunk2@razooIE20.com", "123456")
		donateUsingNewCard("10.00", "Normal2 UserIE", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normaltrunk2@razooIE20.com")
		normalUserSharePage("sharepage@aol.com", "/story/Harvard-College")
		checkMydonation("10.00")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_10_login_while_donating()
		...
		searchOrg("RazooTrunkIE ORG20")
		gotoDonFormClickLogin("11.00", "normaltrunk2@razooIE20.com", "123456")
