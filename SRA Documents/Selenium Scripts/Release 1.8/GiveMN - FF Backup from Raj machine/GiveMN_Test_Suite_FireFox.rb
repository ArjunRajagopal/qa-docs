...
# --------------------------------------------------------------------------------------------------------------------#
	...
	def test_02_guestuser_share_story()
		...
		donateUsingNewCard("10.00", "Sample UserFFa", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "sampleuserffa@aol.com")
		guestUserSharePage("sharepagea@aol.com")
...
# -----------------------------------------------------------------------------------------------------#
	...
	def test_03_guestuser_donation_ORG()
		...
		searchOrg("Minnesota Community Foundation")
		donateUsingNewCard("10.00", "Sample UserFFa", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "normalStagea@razoofirefox1.com")
		createRazooAccount("Normal1", "UserFFa", "normalStagea@razoofirefox1.com", "123456")
...
# --------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_normaluser_share_donation_FR_NewCard()
		...
		searchOrg("Minnesota Community Foundation")
		createStoryPage("Minnesota Community Foundation", "RazooStageFirefoxFRa for Minnesota Community Foundation", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=30", "link=Donations", "10", "Suggested Amount")
		donateUsingNewCard("10.50", "Normal1 UserFFa", "2nd Street", "Washington DC", 
				"Washington", "95008", "4111111111111111", "123", "normalStagea@razoofirefox1.com")
		normalUserSharePage("sharepagea@aol.com")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_05_orgadmin_donation_PRO_SavedCard()
		...
		grantOrgAdminRights("/admin", "normalStagea@razoofirefox1.com", "410832480")
		logout()
		# PRE - CONDITION - END
		login("normalStagea@razoofirefox1.com", "123456")
		createStoryPage("Minnesota Community Foundation", "RazooStageFirefoxPROa of Minnesota Community Foundation", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=30", "link=Donations", "10", "Suggested Amount")
...
#~ # ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_06_AddNewCard_deletecomment_removefan()
		...
		removeFan("RazooStageFirefoxFRa for Minnesota Community Foundation")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_08_change_mypassword()
		...
		logout()
		login("normalStagea@razoofirefox1.com", "1234567")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_01_createORG_NPOdetails_audit()
		...
		login("srajkumar.here@gmail.com", "razoo1")
		createOrg("/admin", "511113450", "RazooStageFirefox ORGa", "Minnesota", "Minnesota")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_09_createaccount_while_donating()
		...
		sleep 5
		searchOrg("RazooStageFirefox ORG3a")
		gotoDonFormClickSignup("10.00")
		createRazooAccount("Normal2", "UserFF1", "normalStage2a@razoofirefox1.com", "123456")
		donateUsingNewCard("10.00", "Normal2 UserFF1a", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normalStage2a@razoofirefox1.com")
		normalUserSharePage("sharepagea@aol.com")
		checkMydonation("10.00")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_10_login_while_donating()
		...
		searchOrg("RazooStageFirefox ORG3a")
		gotoDonFormClickLogin("10.00", "normalStage2a@razoofirefox1.com", "123456")
		donateUsingNewCard("10.00", "Normal2 UserFFa", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normalStage2a@razoofirefox1.com")
		normalUserSharePage("sharepagea@aol.com")
		logout()
