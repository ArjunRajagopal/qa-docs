...
# -----------------------------------------------------------------------------------------------------#
	...
	def test_03_guestuser_donation_ORG()
		...
		searchOrg("Harvard College")
		donateUsingNewCard("10.00", "Sample UserFF", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "normaltrunk1@razoofirefox7.com")
		createRazooAccount("Normal1", "UserFF6", "normaltrunk1@razoofirefox7.com", "123456")
...
# --------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_normaluser_share_donation_FR_NewCard()
		...
		searchOrg("Harvard College")
		createStoryPage("Harvard College", "RazooTrunkFirefoxFR3A for Harvard College", "Summary Part ", "Story Part", 
		...
		donateUsingNewCard("10.50", "Normal1 UserFF", "2nd Street", "Washington DC", 
				"Washington", "95008", "4111111111111111", "123", "normaltrunk1@razoofirefox5.com")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_05_orgadmin_donation_PRO_SavedCard()
		...
		grantOrgAdminRights("/admin", "normaltrunk1@razoofirefox5.com", "042103580")
		logout()
		# PRE - CONDITION - END
		login("normaltrunk1@razoofirefox5.com", "123456")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_08_change_mypassword()
		...
		logout()
		login("normaltrunk1@razoofirefox5.com", "1234567")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_01_createORG_NPOdetails_audit()
		...
		login("ebi@srasys.co.in", "123456")
		createOrg("/admin", "511111115", "RazooTrunkFirefox ORG5", "Firefox City", "Firefox State")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_09_createaccount_while_donating()
		...
		sleep 5
		searchOrg("RazooTrunkFirefox ORG4")
		gotoDonFormClickSignup("10.00")
		createRazooAccount("Normal2", "UserFF", "normaltrunk2@razoofirefox7.com", "123456")
		donateUsingNewCard("10.00", "Normal2 UserFF", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normaltrunk2@razoofirefox7.com")
		normalUserSharePage("sharepage@aol.com")
		checkMydonation("10.00")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_10_login_while_donating()
		...
		searchOrg("RazooTrunkFirefox ORG4")
		gotoDonFormClickLogin("10.00", "normaltrunk2@razoofirefox7.com", "123456")
		donateUsingNewCard("10.00", "Normal2 UserFF", "2nd Street", "Washington DC", 
					 "Washington", "95008", "4111111111111111", "123", "normaltrunk2@razoofirefox7.com")
		normalUserSharePage("sharepage@aol.com")
		logout()
