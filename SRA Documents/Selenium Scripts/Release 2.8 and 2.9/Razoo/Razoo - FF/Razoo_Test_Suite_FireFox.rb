...
$test_data ="K:\\EBI\\Razoo\\Automation\\Selenium\\Release 2.8\\Razoo\\Razoo - FF\\Razoo_Firefox_TestData.xls"
...
class RazooTestSuite < TestingBot::TestCase
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	...
	def scenario7()
		...
		$browser.open "http://www-qarc.razoo.com/story/Project252-Of-Harvard-College-For-Release-2-5"
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#
# SCENARIO 28 : AS RAZOO ADMIN ISBAT CREATE SCHOOL AND MAKE A DONATION
# -------------------------------------------------------------------------------------------------------------------------------------------------------------#	
	def scenario28()
	...
	def test_01_Razoo()
		...
		scenario28() #As Raz Admin Create School and Donate
