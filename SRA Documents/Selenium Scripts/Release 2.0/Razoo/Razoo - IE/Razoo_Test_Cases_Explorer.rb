...
# 18-Oct-2011 - Update - Release 1.25.3 # 2-Nov-2011 - Update - Release 1.26
#-----------------------------------------------------------------------------#
...
def createStoryPage(ein_number, org_name, story_name, story_summary, page_story, youtube_url, desig_value, goal_amount,  goal_date, admin_links, sug_amount, sug_desc)
	...
	begin
		assert $browser.is_text_present("Your fundraiser is 72% complete.")
		puts "Step 11 : Passed. 72% complete label gets displayed in FR completion steps progress bar."
	rescue Test::Unit::AssertionFailedError
...
def createThemedFundraiser(themedfr_url, normal1_firstname, normal1_lastname, story_summary, page_story, sug_desc, donation_amount)
	
	puts "************** START : Create Themed Fundraiser ****************"
	begin
		$browser.open themedfr_url
		assert $browser.is_text_present("Theme")
		sleep 25
		$browser.type "id=org_picker_kw", "harvard"
		...
		begin
			assert $browser.is_text_present("Fundraiser Setup")
		...
		puts "Fail. User has failed to reach the Theme page."
	end
...
def causesAndPersonIlike(org2_url, org3_url, new_orgname3, first_name1, last_name, email_id1, first_name2, email_id2, pass_word)
	...
	begin
		assert $browser.is_element_present("//div[@id='people_i_may_know']/ol/li[1]/a/img")
		puts "Pass. Person I May Know image is displayed under User1 Profile screen."
	rescue Test::Unit::AssertionFailedError
		puts "Fail. Person I May Know image is not displayed under User1 Profile screen."
	end
	begin
		assert $browser.is_element_present("css=ol.populated > li > a > img.snapshot.photo")
