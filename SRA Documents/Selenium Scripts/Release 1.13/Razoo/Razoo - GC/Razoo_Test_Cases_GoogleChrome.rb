...
def createStoryPage(ein_number, org_name, story_name, story_summary, page_story, youtube_url, desig_value, goal_amount,  goal_date, admin_links, sug_amount, sug_desc)
	...
	begin
		assert $browser.is_element_present("link=See your page now")
		$browser.click "link=See your page now"
		$browser.wait_for_page_to_load 
	rescue Test::Unit::AssertionFailedError
	end
	begin
...
def createTeamFundraiserTemplate(story_summary, camp_goalamount)
	...
	$browser.type "//body[@id='tinymce']", story_summary
	$browser.click "//a[@id='fundraiser_template_long_description_numlist']/span"
	$browser.click "//a[@id='fundraiser_template_long_description_indent']/span"
	$browser.click "//a[@id='fundraiser_template_long_description_outdent']/span"
	$browser.click "//a[@id='fundraiser_template_long_description_numlist']/span"
	...
	$browser.click "//em[@id='create_a_page']"
	$browser.wait_for_page_to_load 
	begin
...
def removeOrgAdminRights(email_id)
	
	puts "************** START : Remove ORG Admin rights ****************"	
	begin
        assert $browser.is_element_present("link=Admins")
	$browser.click "link=Admins"
	$browser.wait_for_page_to_load 
	$browser.type "email", email_id
	$browser.click "commit"
	$browser.wait_for_page_to_load 
	...
	begin
		...
		puts "Step 1 : Passed. #{email_id} user successfully removed from Org Admins section."
	rescue Test::Unit::AssertionFailedError
		puts "Step 1 : Failed. #{email_id} user is not successfully removed from Org Admins section."
	end
	begin
