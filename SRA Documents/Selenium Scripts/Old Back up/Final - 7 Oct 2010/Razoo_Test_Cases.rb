...
def createStoryPage(org_name, story_name, story_summary, page_story, youtube_url, desig_value, goal_amount,  goal_date, admin_links, sug_amount, sug_desc)
	...
	#~ $browser.click "//a[@id='story_story_pastetext']/span"
	#~ sleep(10)
	#~ $browser.wait_for_pop_up "name=Paste as Plain Text", "30000"
	#~ $browser.select_pop_up "name=Paste as Plain Text"
	#~ $browser.type "htmlSource", "asdasd"
	#~ $browser.click "insert"
	#~ $browser.select_window "null"
	#$browser.click "image_radio"
	#$browser.type "imageChooser", "C:\\Documents and Settings\\All Users\\Documents\\My Pictures\\Sample Pictures\\Sunset.jpg"
