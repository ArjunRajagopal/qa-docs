...
# -----------------------------------------------------------------------------------------------------#
	...
	#~ def test_01_guestuser_donation_ORG()
		...
		#~ viewComments()
		#~ createRazooAccount("Mr", "Oct", "oct6@aol.com", "123456")
...
# ----------------------------------------------------------------------------------------------------------------------------------#
	#~ def test_02_normaluser_donation_FR()
		...
		#~ searchStory("Harvard College")
		#~ createStoryPage("Harvard College", "FR11 for Harvard College", "Summary Part ", "Story Part", 
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
#SCENARIO 3 : AS AN ORG ADMIN USER ISBAT CREATE PROEJCT PAGE, DONATE  WITH TIPS TO PRO AND POST COMMENT.
#
# PRE - CONDITION : 
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_03_orgadmin_donation_PRO()
		...
		createStoryPage("Harvard College", "PRO11 of Harvard College", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=31", "link=Donations", "10", "Suggested Amount")
