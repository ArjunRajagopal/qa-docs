...
def verifySingleCauseLeaderboard(modified_camp_url, teamcamp_fr)
...
def verifyNpoDetails()	
	...
	begin
		...
		assert_equal "#{$new_einlessorgname} - Razoo", $browser.get_title
		puts "Step 1 : Passed. User has reached #{$new_einlessorgname} story page successfully."
	end
	begin
