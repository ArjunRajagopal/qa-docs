...
# -----------------------------------------------------------------------------------------------------#
	...
	def test_02_guestuser_donation_ORG()
		...
		donateUsingNewCard("10.00", "Sample UserSF", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "sampleusersf@aol.com")
		createRazooAccount("Sample", "UserSF", "normaltrunk@safari6.com", "123456")
...
# --------------------------------------------------------------------------------------------------------------------------------------#
	def test_03_normaluser_share_donation_FR_NewCard()
		...
		searchOrg("Harvard College")
		createStoryPage("Harvard College", "SafariTrunk FR5 for Harvard College", "Summary Part ", "Story Part", 
		...
		donateUsingNewCard("10.50", "Mr Oct5", "2nd Street", "Washington DC", 
				"Washington", "95008", "4111111111111111", "123", "normaltrunk@safari5.com")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_orgadmin_donation_PRO_SavedCard()
		...
		grantOrgAdminRights("/admin", "normaltrunk@safari5.com", "042103580")
		logout()
		# PRE - CONDITION - END
		login("normaltrunk@safari5.com", "123456")
		createStoryPage("Harvard College", "SafariTrunk PRO5 of Harvard College", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=31", "link=Donations", "10", "Suggested Amount")
...
#~ # ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_05_AddNewCard_deletecomment_removefan()
		...
		removeFan("SafariTrunk FR4 for Harvard College")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_07_change_mypassword()
		...
		logout()
		login("normaltrunk@safari5.com", "1234567")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_08_createORG_NPOdetails_audit()
		...
		login("ebi@srasys.co.in", "123456")
		createOrg("/admin", "311111114", "SafariTrunk ORG4", "Safari City", "Safari State")
