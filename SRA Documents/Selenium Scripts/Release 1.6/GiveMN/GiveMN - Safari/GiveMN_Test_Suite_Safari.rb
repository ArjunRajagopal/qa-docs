...
require "GiveMN_Test_Cases_Safari.rb"
...
# -----------------------------------------------------------------------------------------------------#
	...
	def test_01_guestuser_donation_ORG()
		...
		donateUsingNewCard("10.00", "Sample UserSF", "2nd Street", "Washington DC", 
					"Washington", "95008", "4111111111111111", "123", "sampleusersf@aol.com")
		viewComments()
		createRazooAccount("Sample", "UserSF4", "normal@safari4.com", "123456")
...
# ----------------------------------------------------------------------------------------------------------------------------------#
	def test_02_normaluser_donation_FR_NewCard()
		...
		searchOrg("Minnesota Community Foundation")
		createStoryPage("Minnesota Community Foundation", "Safari FR4 for Minnesota Community Foundation", "Summary Part ", "Story Part", 
		...
		donateUsingNewCard("10.50", "Mr Oct5", "2nd Street", "Washington DC", 
				"Washington", "95008", "4111111111111111", "123", "normal@safari4.com")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_03_orgadmin_donation_PRO_SavedCard()
		...
		grantOrgAdminRights("/admin", "normal@safari4.com", "410832480")
		logout()
		# PRE - CONDITION - END
		login("normal@safari4.com", "123456")
		createStoryPage("Minnesota Community Foundation", "Safari PRO4 of Minnesota Community Foundation", "Summary Part ", "Story Part", 
				"http://www.youtube.com/watch?v=HNVSI_r9SVg" , "With Designation", 
				"100",  "link=31", "link=Donations", "10", "Suggested Amount")
...
#~ # ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_04_AddNewCard_deletecomment_removefan()
		...
		removeFan("Safari FR4 for Minnesota Community Foundation")
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_06_change_mypassword()
		...
		logout()
		login("normal@safari4.com", "1234567")
		logout()
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------#
	def test_07_createORG_NPOdetails_audit()
		...
		login("srajkumar.here@gmail.com", "razoo1")
		createOrg("/admin", "311111114", "Safari ORG4", "Safari City", "Safari State")
		editNpoDetails("First Name", "Last Name", "Addres 1", "Addres 2", "razoo@safari.com", "123456789")
