...
def login(email_id, pass_word)
	...
	$browser.type "//input[@id='user_session_email']", email_id 
	$browser.type "//input[@id='user_session_password']", pass_word
	#***************** Button position check *****************#
...
def donateUsingNewCard(donation_amount, name_on_card, street, city, state, pin_code, card_number, sec_code, email_id)
	...
	#GUEST USER AC CREATION 
		assert $browser.is_text_present("Also create an account on Razoo")
...
def checkMydonation(donation_amount, org_name)
	...
	$browser.wait_for_page_to_load 
	begin
		puts "Step 1 : Verify NPO category icons in the Profile screen."
		...
		puts "@@@@@@@@@ FAILED @@@@@@@@@ Animals category icon is not displayed for #{org_name} NPO in Profile screen."
	end
	$browser.click "link=My Profile"
	$browser.wait_for_page_to_load 
	begin
	...
	puts "Step 3 : Verify donation details under Recent Activity section."
	begin
...
def causesAndPersonIlike(org2_url, org3_url, new_orgname3, first_name1, last_name, email_id1, first_name2, email_id2, pass_word)
	...
	# User 1 creation
	createRazooAccount(first_name1, last_name, email_id1, pass_word)
	...
	createRazooAccount(first_name2, last_name, email_id2, pass_word)
	$browser.open org2_url
	$browser.wait_for_page_to_load 
...
def deleteMyStoryPage(pro_name)
	...
	$browser.wait_for_page_to_load 
	begin
		assert $browser.is_element_present("link=#{pro_name}")
...
def loginViaGmail(gmail_emailId, gmail_password)
	...
	if @SigninwithGooglebutton_topposition == '6' or @SigninwithGooglebutton_topposition == '5'
...
def loginViaFacebook(fb_emailId, fb_password)
	...
	if @Signinwithfacebookbutton_topposition == '5'
...
def editSchoolDetails(org_url, first_name, last_name, add_1, add_2, org_emailid, phone_num)	
	#~ def editSchoolDetails(school_url, org_firstname, org_lastname, org_address1, org_address2, org_emailId, org_phonenum)
