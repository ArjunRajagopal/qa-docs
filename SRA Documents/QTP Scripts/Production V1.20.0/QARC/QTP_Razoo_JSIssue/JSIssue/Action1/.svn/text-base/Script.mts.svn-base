...
'Home Page Screen
'==================
Browser("An inspiring place to").Navigate "http://www-qarc.razoo.com/"
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("Donation_Transaction_Amount").Set "30.00"
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").Link("Hp Razoo").Click @@ hightlight id_;_Browser("An inspiring place to").Page("Fr page - Razoo").Link("My account")_;_script infofile_;_ZIP::ssf69.xml_;_
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Navigate("http://www-qarc.razoo.com/admin")

'Admin Page
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Navigate("http://www-qarc.razoo.com/homepage_marquees")
...
'===================
Browser("An inspiring place to").Navigate("http://www-qarc.razoo.com/admin/find_user")
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)

'Manage Org Admin
'===============
Browser("An inspiring place to").Navigate("https://www-qarc.razoo.com/admin/org_admins")
...
Browser("An inspiring place to").Navigate("https://www-qarc.razoo.com/admin/orders")
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
...
Browser("An inspiring place to").Navigate "https://www-qarc.razoo.com/admin/disbursements/new"
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)

'Disbursement Adjustment Type
Browser("An inspiring place to").Navigate "https://www-qarc.razoo.com/admin/disbursement_adjustment_types"
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
...
'========================
Browser("An inspiring place to").Navigate "https://www-qarc.razoo.com/admin/disbursement_exports/new" @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 24").Link("<< Back to Admin Page")_;_script infofile_;_ZIP::ssf117.xml_;_
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
...
Browser("An inspiring place to").Navigate "https://www-qarc.razoo.com/admin/reports"
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
...
'IRS Master Import 
Browser("An inspiring place to").Navigate ("https://www-qarc.razoo.com/admin/irs_masters_imports") @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 26").Link("Irs Master Import")_;_script infofile_;_ZIP::ssf436.xml_;_
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)

'Create New ORG
'===============
Browser("An inspiring place to").Navigate "https://www-qarc.razoo.com/admin/organizations/new"
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Navigate "https://www-qarc.razoo.com/organizations/Org-For-Js1/audits"
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Navigate "http://www-qarc.razoo.com/admin/verify_authorize_net_log"

'Authorise.net Log
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Navigate "https://www-qarc.razoo.com/admin/guest_orders"

'Assign Guest Orders to
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Navigate "https://www-qarc.razoo.com/admin/order_blacklists"

'See Order Black List Rules
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Navigate "http://www-qarc.razoo.com/admin/abingo_dashboard"
...
Browser("An inspiring place to").Navigate "https://www-qarc.razoo.com/team/new"
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("campaign[start_at]").Set "Jul 21, 2011"
