...
'Mail.To = "rmo@srasys.co.in; rki@srasys.co.in;sdr@srasys.co.in; sht@srasys.co.in; sid@srasys.co.in" 'Enter your mail id here
'Mail.Subject = "QTP Script Execution-Status"
'Mail.Body = "Regression Testing Release 1.19 Round1 TestSuite Execution is Completed, Please check for the Results for all test Cases"
'Mail.display
