...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("user[first_name]").Set "Razoo"
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("user[last_name]").Set "Normaluser1" 
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("user[email]").Set "razoonormaluser1@sra.com"
...
Browser("An inspiring place to").Page("An inspiring place to").Image("Razoo").Click
Browser("An inspiring place to").Page("An inspiring place to").Link("donate > Find and support").Click
Browser("An inspiring place to").Page("An inspiring place to").WebCheckBox("preferredNposOnly").Set "OFF"
Browser("An inspiring place to").Page("An inspiring place to").WebCheckBox("projectScope").Set "OFF"
Browser("An inspiring place to").Page("An inspiring place to").WebCheckBox("widgetScope").Set "OFF"
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
Call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to_2").WebEdit("donation[amount]").Set "30"
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("order_user_order[credit_card_a_2").Set "Razoo Normaluser1"
...
Browser("An inspiring place to").Page("An inspiring place to").Link("Razoo Normaluser1").Click
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("story[title]").Set "Fr page1"
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("story[short_description]").Set "Fr page1"
Browser("An inspiring place to").Page("An inspiring place to").WebElement("WebElement").Click
Browser("HTML Source Editor").Page("HTML Source Editor").WebEdit("htmlSource").Set "Story for FR Page1"
...
Browser("An inspiring place to").Page("An inspiring place to").WebButton("Save").Click

'Upload Image
'=============
Browser("An inspiring place to").Page("An inspiring place to").Link("Images/Videos").Click
Browser("An inspiring place to").Page("An inspiring place to").WebFile("story[story_image]").Set "C:\Documents and Settings\All Users\Documents\My Pictures\Sample Pictures\sunset.jpg"
Browser("An inspiring place to").Page("An inspiring place to").WebButton("Save").Click
...
Browser("An inspiring place to").Page("An inspiring place to").Link("Fr page3").Click @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 11").Link("Fr page")_;_script infofile_;_ZIP::ssf73.xml_;_
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("email").Set "RazooNormaluser1@sra.com"
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("ein").Set "123456701"
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("number").Set "209" @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 14").WebEdit("number")_;_script infofile_;_ZIP::ssf81.xml_;_
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("org[ein]").Set "123451244"
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("org[name]").Set "ORGFORJSISSUE1" @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 28").WebEdit("org[name]")_;_script infofile_;_ZIP::ssf120.xml_;_
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Navigate "https://www-qaindia.razoo.com/organizations/OrgForJsissue1/audits"

'Verify Audits Page
'================
Browser("An inspiring place to").Page("An inspiring place to").Link("Verify").Click
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("campaign[title]").Set "Team1 for Jsissue" @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 42").WebEdit("campaign[title]")_;_script infofile_;_ZIP::ssf449.xml_;_
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("campaign[start_at]").Set "Oct 28, 2011"
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("campaign[cached_urn]").Set "team3-jsissue" @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 42").WebEdit("campaign[cached urn]")_;_script infofile_;_ZIP::ssf460.xml_;_
...
'Create Fundariser  page for team 
'==============================
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("story[title]").Set "FR for team1 for Jsissue " @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 44").WebEdit("story[title]")_;_script infofile_;_ZIP::ssf463.xml_;_
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("campaign_urn").Set "team1-fr"  
Browser("An inspiring place to").Page("An inspiring place to").WebButton("Save").Click
Browser("An inspiring place to").Page("An inspiring place to").Link("Log out").Click