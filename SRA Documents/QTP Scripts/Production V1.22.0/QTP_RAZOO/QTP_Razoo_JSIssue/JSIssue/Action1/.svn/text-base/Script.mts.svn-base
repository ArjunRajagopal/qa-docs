...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("kw").Set "TEST ORG1 WITH EIN2"
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("kw").Submit
Browser("An inspiring place to").Page("An inspiring place to").Link("TEST ORG1 WITH EIN2").Click
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("org_picker_kw").Set "TEST ORG1 WITH EIN2"
