...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("user[email]").Set "HpRazoo5@sra.com"
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("kw").Set "TEST ORG1 WITH EIN5"
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("kw").Submit
Browser("An inspiring place to").Page("An inspiring place to").Link("TEST ORG1 WITH EIN5").Click
...
'Browser("An inspiring place to").Page("An inspiring place to").Link("My account").Click
Browser("An inspiring place to").Page("An inspiring place to").Link("Hp Razoo").Click
...
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("donation[amount]").Set "30.00"
'Browser("An inspiring place to").Page("An inspiring place to").WebRadioGroup("tip_amount").Select "5.00" 
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("order_user_order[credit_card_a_2").Set "Hp Razoo"
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("order_user_order[credit_card_a").Set "Wood RidgeDrive" 
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("order_user_order[credit_card_a_3").Set "Washington DC"
Browser("An inspiring place to").Page("An inspiring place to").WebList("order_user_order[credit_card_a_4").Select "Washington"
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("org_picker_kw").Set "TEST ORG1 WITH EIN5"
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("story[title]").Set "Fr page5"
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("story[short_description]").Set "Fr page5"
Browser("An inspiring place to").Page("An inspiring place to").WebElement("WebElement").Click
Browser("HTML Source Editor").Page("HTML Source Editor").WebEdit("htmlSource").Set "Story for FR Page5"
...
Browser("An inspiring place to").Page("An inspiring place to").Link("Fr page5").Click @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 11").Link("Fr page")_;_script infofile_;_ZIP::ssf73.xml_;_
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("email").Set "HPRazoo5@sra.com"
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("ein").Set "123456792"
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("org[ein]").Set "123451242"
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("org[name]").Set "ORG FOR JS5" @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 28").WebEdit("org[name]")_;_script infofile_;_ZIP::ssf120.xml_;_
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Navigate "https://www-qaindia.razoo.com/organizations/Org-For-Js5/audits"
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("campaign[title]").Set "Champ Alli5" @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 42").WebEdit("campaign[title]")_;_script infofile_;_ZIP::ssf449.xml_;_
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("campaign[start_at]").Set "Nov 9, 2011"
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("campaign[cached_urn]").Set "champ-alli75" @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 42").WebEdit("campaign[cached urn]")_;_script infofile_;_ZIP::ssf460.xml_;_
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("story[title]").Set "FR Alliance Champ Page5" @@ hightlight id_;_Browser("An inspiring place to").Page("An inspiring place to 44").WebEdit("story[title]")_;_script infofile_;_ZIP::ssf463.xml_;_
...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("campaign_urn").Set "FrAl75"  
