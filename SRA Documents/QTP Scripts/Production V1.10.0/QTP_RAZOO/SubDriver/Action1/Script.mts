...
'Datatable variables
Dim strComponent,strBrowser,strObject,strObjectName,strAction,strParam,strExpected,strChkpoint,strWindow
...
Dim intPass,intFail,rcnt,Myvalue 
Dim strPage
...
For  k=1 to intsdrRowCount step 1
	...
	strWindow=DataTable.GetSheet("SubDriver [SubDriver]").GetParameter("Window").ValueByRow(k)
	...
	Select Case strComponent
		Case "Web"
				...
				Select Case strObject
					...
					Case "WebElement"
                             		Call fnElement (strBrowser,strWindow,strPage,strObjectName,strAction,strParam,strExpected,strChkPoint)
				   ...
				   Case "WinButton"
					...
					Case "WinStatusBar"
                           		 Call fnWinStatusBar (strBrowser,strObjectName,strAction,strParam,strExpected,strChkPoint)
...
'rcnt=k
'Myvalue=1
'Call fnCheckResults(intPass,intFail,rcnt)
'sht
Call fnResultsWindow(intPassCount,intFailCount,k)
'sht
'msgbox Myvalue
'If Myvalue=1 Then
'	Parameter("results")="Passed"
'	msgbox Parameter("results")
'Else
'	Parameter("results")="Failed"
'	msgbox Parameter("results")
'End if
'sht

'Parameter("intFcount")=intFailCount
'========================================
