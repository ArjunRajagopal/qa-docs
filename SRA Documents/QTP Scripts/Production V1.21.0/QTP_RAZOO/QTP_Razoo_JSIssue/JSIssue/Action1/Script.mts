...
Browser("An inspiring place to").Page("An inspiring place to").WebEdit("user[email]").Set "HpRazoo4@sra.com"
...
Browser("An inspiring place to").WinStatusBar("msctls_statusbar32").DblClick 100,11
call fnDetect_CloseJavaScriptError(WebBrowserDesc,WebPageDesc)
Browser("An inspiring place to").Page("Fr page - Razoo").Link("Hp Razoo").Click @@ hightlight id_;_Browser("An inspiring place to").Page("Fr page - Razoo").Link("My account")_;_script infofile_;_ZIP::ssf69.xml_;_
...
Browser("An inspiring place to").Page("An inspiring place to").WebLink("Log out").Click