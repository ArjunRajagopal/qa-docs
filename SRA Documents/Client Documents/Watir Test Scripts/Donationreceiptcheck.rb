...
ff.text_field(:id, "parametricKeyword").set("Lance Armstrong Foundation, Inc.")
sleep 5
ff.link(:text,"Lance Armstrong Foundation, Inc.").click
if ff.text.include? "Lance"
...
ff.text_field(:id, "donation_amount").set("47")
...
puts "Step 4: Clicking donate button"
ff.radio(:id, "customDonationLevel", "custom").set
ff.text_field(:id, "donation_amount").set("57")
ff.button(:id,"storyDonateButton").click
